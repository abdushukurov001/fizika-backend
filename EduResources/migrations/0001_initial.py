    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='EduResources.classes')),
            ],
            options={
                'verbose_name': 'Mavzu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tests', to='EduResources.lessons')),
            ],
            options={
